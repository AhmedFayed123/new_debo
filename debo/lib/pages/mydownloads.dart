...
import 'myepisodedownloads.dart';
                  ...
                  InkWell(
                    ...
                    onTap: () async {
                      ...
                      Utils.openDetails(
                        ...
                        typeId: myDownloadsList?[position].typeId ?? 0,
                        newPage: (myDownloadsList?[position].videoType == 2 ||
                                myDownloadsList?[position].subVideoType == 2)
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Row(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.center,
                    children: [
                      (myDownloadsList?[position].description ?? "").isNotEmpty
                          ? Container(
                              padding: const EdgeInsets.fromLTRB(5, 5, 5, 5),
                              margin: const EdgeInsets.only(right: 8),
                              decoration: Utils.setBGWithBorder(
                                  transparent, descTextColor, 3, 0.7),
                              child: MyText(
                                text: myDownloadsList?[position].description ??
                                    "",
                                multilanguage: false,
                                fontsizeNormal: 10,
                                fontsizeWeb: 12,
                  ...
                  InkWell(
                    ...
                    onTap: () {
                      ...
                      String message = "Hey! I'm watching ${myDownloadsList?[position].name ?? ""}. Check it out now on ${Constant.appName}! \n${Platform.isIOS ? Constant.iosAppUrl : Constant.androidAppUrl} \n";
