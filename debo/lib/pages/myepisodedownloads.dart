                  ...
                  InkWell(
                    ...
                    onTap: () async {
                      ...
                      Utils.openDetails(
                        ...
                        newPage:
                            (widget.videoType == 2 || widget.subVideoType == 2)
  ...
  Future<bool> deleteFromDownloads(position) async {
    ...
    for (int i = 0; i < episodeBox.values.toList().length; i++) {
      ...
      if (myEpisodeData != null &&
          ...
          myEpisodeData.showId == myEpisodeList?[position].showId) {
        printLog(
            "myDownloadsList showId ====> ${myEpisodeList?[position].showId}");
    ...
    if (episodeBox.values.toList().isEmpty) {
      ...
      for (int i = 0; i < seasonBox.values.toList().length; i++) {
        ...
        if (mySeasonData != null &&
            ...
            mySeasonData.showId ==
                mySeasonList?[downloadProvider.seasonClickIndex ?? 0].showId) {
          printLog(
              "myDownloadsList showId ====> ${mySeasonList?[downloadProvider.seasonClickIndex ?? 0].showId}");
    ...
    if (downloadBox.values.toList().isNotEmpty &&
      ...
      for (int i = 0; i < downloadBox.values.toList().length; i++) {
        ...
        if (myDownloadData != null &&
            myDownloadData.id == widget.showId &&
            myDownloadData.videoType == widget.videoType &&
            myDownloadData.typeId == widget.typeId) {
          printLog("myDownloadsList showId =======> ${widget.showId}");
                ...
                children: <Widget>[
                  ...
                  InkWell(
                    ...
                    onTap: () {
                      ...
                      String message = "Hey! I'm watching ${myEpisodeList?[position].description ?? ""}. Check it out now on ${Constant.appName}! \n${Platform.isIOS ? Constant.iosAppUrl : Constant.androidAppUrl} \n";
