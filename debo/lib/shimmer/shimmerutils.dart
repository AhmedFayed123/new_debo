...
import 'package:debo/shimmer/shimmerwidget.dart';
...
class ShimmerUtils {
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                /* Category */
                Container(
                  margin: const EdgeInsets.fromLTRB(20, 5, 20, 38),
                  alignment: Alignment.center,
                  child: ClipRRect(
                    borderRadius: BorderRadius.circular(5),
                    child: ShimmerWidget.roundrectborder(
  ...
  static Widget sectionPortraitListView(context) {
    return Column(
      children: [
        Container(
          padding: EdgeInsets.fromLTRB(Dimens.isBigScreen(context) ? 35 : 20, 0,
        ...
        Stack(
          ...
          children: [
            Container(
              padding: const EdgeInsets.all(0),
              width: MediaQuery.of(context).size.width,
              height: kIsWeb ? Dimens.detailPosterWeb : Dimens.detailPoster,
              child: ShimmerWidget.roundcorner(
                height: kIsWeb ? Dimens.detailPosterWeb : Dimens.detailPoster,
                shapeBorder: const RoundedRectangleBorder(
  ...
  static Widget buildAvatarGridShimmer(context, double itemHeight,
      double itemWidth, int crossAxisCount, int itemCount) {
    return AlignedGridView.count(
      shrinkWrap: true,
      crossAxisCount: crossAxisCount,
      crossAxisSpacing: 8,
  ...
  static Widget buildAvatarGridWebShimmer(context, double itemHeight,
      double itemWidth, int crossAxisCount, int itemCount) {
    return Container(
      padding: const EdgeInsets.fromLTRB(20, 8, 20, 8),
      child: ResponsiveGridList(
  ...
  static Widget buildEpisodeShimmer(context, int itemCount) {
    return AlignedGridView.count(
      shrinkWrap: true,
      crossAxisCount: 1,
      crossAxisSpacing: 0,
      ...
      itemBuilder: (BuildContext context, int position) {
        return Container(
          ...
          constraints: BoxConstraints(
              minHeight:
                  kIsWeb ? Dimens.heightEpiLandWeb : Dimens.heightEpiLand),
          ...
          child: Row(
            ...
            children: [
              Container(
                ...
                child: ClipRRect(
                  borderRadius: BorderRadius.circular(
                      kIsWeb ? Dimens.cardRadiusWeb : Dimens.cardRadius),
                  clipBehavior: Clip.antiAliasWithSaveLayer,
                  child: ShimmerWidget.roundrectborder(
                    height:
                        kIsWeb ? Dimens.heightEpiLandWeb : Dimens.heightEpiLand,
                    width:
                        kIsWeb ? Dimens.widthEpiLandWeb : Dimens.widthEpiLand,
                    shapeBorder: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(
                            kIsWeb ? Dimens.cardRadiusWeb : Dimens.cardRadius)),
                  ),
