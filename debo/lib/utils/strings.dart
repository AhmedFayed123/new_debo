...
const bottomView3 = "Store";
const bottomView4 = "Downloads";
const bottomView5 = "My Space";
...
const enterEmail = "Enter email address";
const more = "More";
const less_ = "...less";
const searchHint = "Search here...";
...
const removeCouponMsg = "Coupon removed.";
