...
class DownloadItemAdapter extends TypeAdapter<DownloadItem> {
  ...
  DownloadItem read(BinaryReader reader) {
    ...
    return DownloadItem(
      ...
      savedDir: fields[5] as String?,
      savedFile: fields[6] as String?,
      videoType: fields[7] as int?,
      subVideoType: fields[8] as int?,
      typeId: fields[9] as int?,
      isPremium: fields[10] as int?,
      isBuy: fields[11] as int?,
      isRent: fields[12] as int?,
      rentBuy: fields[13] as int?,
      rentPrice: fields[14] as int?,
      isDownload: fields[15] as int?,
      videoDuration: fields[16] as int?,
      stopTime: fields[17] as int?,
      videoUploadType: fields[18] as String?,
      trailerUploadType: fields[19] as String?,
      trailerUrl: fields[20] as String?,
      releaseYear: fields[21] as String?,
      landscapeImg: fields[22] as String?,
      thumbnailImg: fields[23] as String?,
      session: (fields[24] as List?)?.cast<SessionItem>(),
    );
  }
...
class EpisodeItemAdapter extends TypeAdapter<EpisodeItem> {
  ...
  EpisodeItem read(BinaryReader reader) {
    ...
    return EpisodeItem(
      ...
      savedDir: fields[18] as String?,
      savedFile: fields[19] as String?,
      subtitleType: fields[20] as String?,
      subtitleLang1: fields[21] as String?,
      subtitleLang2: fields[22] as String?,
      subtitleLang3: fields[23] as String?,
      subtitle1: fields[24] as String?,
      subtitle2: fields[25] as String?,
      subtitle3: fields[26] as String?,
      isDownloaded: fields[27] as int?,
      isBookmark: fields[28] as int?,
      rentBuy: fields[29] as int?,
      isRent: fields[30] as int?,
      rentPrice: fields[31] as int?,
      isBuy: fields[32] as int?,
      categoryName: fields[33] as String?,
      stopTime: fields[34] as int?,
    );
  }
