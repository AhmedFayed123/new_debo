                              ...
                              ? Container(
                                  ...
                                  child: MyText(
                                    ...
                                    text: ((videoDetailsProvider
                                                ...
                                                0) >
                                            0)
                                        ? "$dotText  ${Utils.convertTimeToText(videoDetailsProvider.contentDetailModel.result?[0].videoDuration ?? 0)}"
                                        : "",
                                    textalign: TextAlign.start,
                                    fontsizeNormal: 13,
                                    fontsizeWeb: 15,
            ...
            child: Row(
              ...
              children: [
                ...
                Consumer<VideoDetailsProvider>(
                  builder: (context, videoDetailsProvider, child) {
                    return _buildFeatureBtn(
                      icon: ((videoDetailsProvider.contentDetailModel.result?[0]
                                      .isBookmark ??
                                  0) ==
                              1)
                ...
                Consumer<VideoDetailsProvider>(
                  builder: (context, videoDetailsProvider, child) {
                    return _buildFeatureBtn(
                      ...
                      onClick: () async {
                        if (Constant.userID != null) {
                          await videoDetailsProvider.setLike(
                            context,
                            widget.videoType,
                            widget.subVideoType,
                            widget.videoId,
                ...
                _buildFeatureBtn(
                  ...
                  isRent: false,
                  onClick: () {
                    // Add your comment functionality here, possibly navigating to a comment section
                    ...
                    child: Row(
                      ...
                      children: [
                        Container(
                          ...
                          height: 23,
                          decoration:
                              Utils.setBackground(complimentryColor, 18),
                          alignment: Alignment.center,
                          padding: const EdgeInsets.all(2),
                          child: MyText(
                            color: white,
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Consumer<VideoDetailsProvider>(
                            builder: (context, videoDetailsProvider, child) {
                              return _buildFeatureBtn(
                                icon: ((videoDetailsProvider.contentDetailModel
                                                .result?[0].isBookmark ??
                                            0) ==
                                        1)
                                    ? 'watchlist_remove.png'
