                                ...
                                ? Container(
                                    ...
                                    child: MyText(
                                      ...
                                      text: ((showDetailsProvider
                                                  ...
                                                  0) >
                                              0)
                                          ? "$dotText  ${Utils.convertTimeToText(showDetailsProvider.contentDetailModel.result?[0].videoDuration ?? 0)}"
                                          : "",
                                      textalign: TextAlign.start,
                                      fontsizeNormal: 13,
                                      fontsizeWeb: 15,
              ...
              child: Row(
                ...
                children: [
                  ...
                  Consumer<ShowDetailsProvider>(
                    builder: (context, showDetailsProvider, child) {
                      return _buildFeatureBtn(
                        icon: ((showDetailsProvider.contentDetailModel
                                        .result?[0].isBookmark ??
                                    0) ==
                                1)
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                /* Rent TAG */
                if ((showDetailsProvider.contentDetailModel.result?[0].isRent ??
                        0) ==
                    1)
                  Container(
                    margin: EdgeInsets.only(
                        top: ((showDetailsProvider.contentDetailModel.result?[0]
                                        .isPremium ??
                                    0) ==
                                1)
                            ? 10
