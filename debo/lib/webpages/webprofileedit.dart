...
class _WebProfileEditState extends State<WebProfileEdit> {
  ...
  Widget _buildPage() {
    return Center(
      child: Container(
        ...
        decoration: Utils.setBackground(lightBlack.withOpacity(0.3), 3),
  ...
  void getFromAvatar() async {
    if (!mounted) return;
    final List<String>? pickList = await context.pushNamed(
